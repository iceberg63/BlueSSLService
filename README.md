...
SSL/TLS Add-in framework for [BlueSocket](https://github.com/Kitura-Next/BlueSocket.git) in Swift using the Swift Package Manager. Works on supported Apple platforms (using Secure Transport) and on Linux (using OpenSSL).
...
This library is licensed under Apache 2.0. Full license text is available in [LICENSE](https://github.com/Kitura-Next/BlueSSLService/blob/master/LICENSE).
